        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              />
              <div>
                <h1 className="text-3xl font-bold text-white drop-shadow-lg">Mari, the Chief of Staff Dashboard</h1>
                <p className="text-sm text-indigo-100 mt-1">Agent Reports & Analytics</p>
              </div>
            </div>
            <div className="flex items-center gap-4">
              <a
