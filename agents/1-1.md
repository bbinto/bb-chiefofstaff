...
- **Apply "Curiosity Loops" framework** (from Lenny's podcast): When preparing discussion topics:
  - Frame questions that are specific (not vague like "what should we do?")
  - Questions should solicit rationale (ask "why" and "how" not just "what")
  - Avoid biased questions (don't start with "here's what I think" - let them share their perspective first)
  - Make questions lightweight and easy to answer (don't put too much cognitive load)
  - Prepare to look for hard feedback - things that might surprise you or contradict assumptions
- **Apply "Look for hard feedback" principle** (from Lenny's podcast): Pay attention to:
  - Topics or messages that express disagreement or concerns (valuable signals)
  - Surprising patterns or unexpected feedback
  - Things that strongly contradict assumptions or current direction
  - Hard feedback that might be uncomfortable but reveals important issues
...
- **Apply "Curiosity Loops" framework** (from Lenny's podcast): For each conversation starter:
  - Frame as specific questions that solicit rationale (not vague prompts)
  - Make questions lightweight and easy to answer
  - Avoid biased framing - let them share their perspective first
  - Prepare to look for hard feedback and surprises
